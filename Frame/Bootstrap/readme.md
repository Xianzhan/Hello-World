...
- [BootstrapValidator](#bootstrapvalidator)
    ...
    - [验证](#验证)
        - [在 HTML 上](#在-html-上)
        - [在 JavaScript 上](#在-javascript-上)
    - [自定义验证](#自定义验证)
    - [常用事件](#常用事件)
        - [重置某一单一验证字段验证规则](#重置某一单一验证字段验证规则)
        - [重置表单所有验证规则](#重置表单所有验证规则)
        - [手动触发表单验证](#手动触发表单验证)
        - [获取当前表单验证状态](#获取当前表单验证状态)
        - [根据指定字段名称获取验证对象](#根据指定字段名称获取验证对象)
    - [表单提交](#表单提交)
        - [当提交按钮是普通按钮](#当提交按钮是普通按钮)
        - [当提交按钮的[type=”submit”]时](#当提交按钮的typesubmit时)
