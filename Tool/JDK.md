...
[JDK 13](https://docs.oracle.com/en/java/javase/13/docs/specs/man/index.html)<br>
[JDK 12](https://docs.oracle.com/en/java/javase/12/tools/tools-and-command-reference.html)<br>
[JDK 11](https://docs.oracle.com/en/java/javase/11/tools/tools-and-command-reference.html)<br>
[JDK 10](https://docs.oracle.com/javase/10/tools/tools-and-command-reference.htm#JSWOR596)<br>
[JDK 9](https://docs.oracle.com/javase/9/tools/tools-and-command-reference.htm#JSWOR596)<br>
[JDK 8 UNIX](https://docs.oracle.com/javase/8/docs/technotes/tools/unix/index.html)<br>
[JDK 8 WINDOWS](https://docs.oracle.com/javase/8/docs/technotes/tools/windows/index.html)<br>
[JDK 7](https://docs.oracle.com/javase/7/docs/technotes/tools/index.html)<br>
...
> @since 13<br>
> 为已编译的 Java 方法生成本地代码的 Java 静态编译器
